...
var Geosuggest = function (_React$Component) {
  ...
  _createClass(Geosuggest, [{
    ...
    key: 'clearSuggests',
    value: function clearSuggests() {
      var _this4 = this;

      this.setState({ suggests: [] }, function () {
        return _this4.hideSuggests();
      });
    }
    ...
    value: function searchSuggests() {
      ...
      ['location', 'radius', 'bounds', 'types'].forEach(function (option) {
        if (_this5.props[option]) {
          options[option] = _this5.props[option];
        }
      });
      ...
      this.autocompleteService.getPlacePredictions(options, function (suggestsGoogle) {
        _this5.updateSuggests(suggestsGoogle || []); // can be null

        if (_this5.props.autoActivateFirstSuggest) {
          _this5.activateSuggest('next');
        }
      });
    }
    ...
    value: function updateSuggests() {
      ...
      suggestsGoogle.forEach(function (suggest) {
        if (!skipSuggest(suggest)) {
          suggests.push({
            label: _this6.props.getSuggestLabel(suggest),
    ...
    value: function hideSuggests() {
      ...
      var timer = setTimeout(function () {
        _this7.setState({ isSuggestsHidden: true });
      }, 100);
    ...
    value: function geocodeSuggest(suggest) {
      ...
      this.geocoder.geocode(suggest.placeId ? { placeId: suggest.placeId } : { address: suggest.label }, function (results, status) {
        if (status !== _this8.googleMaps.GeocoderStatus.OK) {
          return;
        }
        ...
        _this8.props.onSuggestSelect(suggest);
      });
    }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_input2.default, _extends({ className: this.props.inputClassName,
          ...
          onNext: function onNext() {
            return _this9.activateSuggest('next');
          },
          onPrev: function onPrev() {
            return _this9.activateSuggest('prev');
          },
          onSelect: function onSelect() {
            return _this9.selectSuggest(_this9.state.activeSuggest);
          },
        ...
        _react2.default.createElement(_suggestList2.default, {
          ...
          onSuggestMouseDown: function onSuggestMouseDown() {
            return _this9.setState({ ignoreBlur: true });
          },
          onSuggestMouseOut: function onSuggestMouseOut() {
            return _this9.setState({ ignoreBlur: false });
          },
